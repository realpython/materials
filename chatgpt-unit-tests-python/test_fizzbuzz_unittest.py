...
class TestFizzBuzz(unittest.TestCase):
    ...
    def test_fizz(self):
        """Test numbers divisible by 3 but not by 5 return 'fizz'"""
        self.assertEqual(fizzbuzz(3), "fizz")
        self.assertEqual(fizzbuzz(6), "fizz")
        self.assertNotEqual(fizzbuzz(15), "fizz")

    def test_buzz(self):
        """Test numbers divisible by 5 but not by 3 return 'buzz'"""
        self.assertEqual(fizzbuzz(5), "buzz")
        self.assertEqual(fizzbuzz(10), "buzz")
        self.assertNotEqual(fizzbuzz(15), "buzz")

    def test_fizzbuzz(self):
        """Test numbers divisible by both 3 and 5 return 'fizz buzz'"""
