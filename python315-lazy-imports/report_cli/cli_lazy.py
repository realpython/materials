...
This is the fast version. Five imports carry the `lazy` keyword, so
the HTTP server, the async runtime, and the GUI toolkit only load if
the code path you take actually reaches them.
"""
