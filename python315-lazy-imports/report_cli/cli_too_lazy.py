...
This version goes one step too far: the two plug-in imports are lazy
as well. They exist purely for their import-time side effect, so
deferring them means they never run and the registry stays empty.
"""
...
import handlers
lazy import handlers.csv_out
lazy import handlers.json_out
