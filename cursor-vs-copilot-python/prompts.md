...
The comparison also uses persistent project instructions to define coding conventions that the editors should follow in future tasks. These are stored in project files rather than submitted as individual chat prompts.
