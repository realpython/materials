...
class PlatformerView(arcade.View):
    ...
    def setup(self) -> None:
        ...
        moving_platforms_list = arcade.tilemap.process_layer(
            map, layer_name=moving_platforms_layer_name, scaling=game.MAP_SCALING,
        )
        ...
        synchronized_platforms_list = arcade.tilemap.process_layer(
            map, layer_name=synchronized_platforms_layer_name, scaling=game.MAP_SCALING,
        )
...
if __name__ == "__main__":
    window = arcade.Window(
        width=game.SCREEN_WIDTH, height=game.SCREEN_HEIGHT, title=game.SCREEN_TITLE,
    )
    title_view = TitleView()
