...
Once you have located your Python executable, open the Start menu and search
for _Edit the system environment variables_ entry,which opens up a
...
_New_ button and paste the path to your Python executable there. Once that is
...
# Setting permanent environment Variable (need to restart shell to take effect)
